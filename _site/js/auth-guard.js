    ...
    init: function() {
      ...
      if (typeof netlifyIdentity !== 'undefined') {
        ...
        if (netlifyIdentity.currentUser !== undefined) {
          // Already initialized, enforce immediately
          this.enforce();
        } else {
          // Wait for init event
        ...
        // If Netlify Identity isn't loaded, wait and retry
        let retries = 0;
        const maxRetries = 5;
        const checkInterval = setInterval(() => {
          ...
          if (typeof netlifyIdentity !== 'undefined') {
            ...
            clearInterval(checkInterval);
            console.warn('Netlify Identity not loaded after', maxRetries, 'attempts');
            // Enforce anyway to show popup
            this.enforce();
          }
        }, 200);
      }
